...
export default function SkyBidder2() {
  const { changeTheme,sidebarTheme,socialTheme,creditTheme,textTheme } = React.useContext(AppContext);
  return (
    <div className={"w-full md:w-[40%] lg:w-[30%] md:absolute top-0 left-0 h-full z-10"+sidebarTheme}>
      <img
